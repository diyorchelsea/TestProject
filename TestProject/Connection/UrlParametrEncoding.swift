...
struct URLParametrEncoding : ParameterEncoding {
    ...
    public static var `default`: URLParametrEncoding { return URLParametrEncoding() }
    
    /// Returns a `URLEncoding` instance with a `.methodDependent` destination.
    public static var methodDependent: URLParametrEncoding { return URLParametrEncoding() }
    
    /// Returns a `URLEncoding` instance with a `.queryString` destination.
    public static var queryString: URLParametrEncoding { return URLParametrEncoding(destination: .queryString) }
    
    /// Returns a `URLEncoding` instance with an `.httpBody` destination.
    public static var httpBody: URLParametrEncoding { return URLParametrEncoding(destination: .httpBody) }
    ...
    public func encode(_ urlRequest: URLRequestConvertible, with parameters: Parameters?) throws -> URLRequest {
        ...
        if encodesParametersInURL(with: method) == true {
